...
export const config = {
  ...
  /** Provider fixture cache TTL for subscription-only matches when no live board is active. */
  jobRefreshLiveMatchesBackgroundFixtureMs: Number(process.env['JOB_REFRESH_LIVE_MATCHES_BACKGROUND_FIXTURE_MS'] || 15_000),
