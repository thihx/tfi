...
function WatchlistCardBase({ item, liveMatch, homeLogo, awayLogo, timeDisplay, leagueDisplay, onEdit, onDelete, onOpenHub }: Props) {
  ...
  return (
    <div
      ...
      title="Tap to view match details"
    >
      ...
      <div style={{
        ...
        <button className="btn btn-secondary btn-sm action-icon-btn" onClick={(e) => { e.stopPropagation(); onEdit(); }} aria-label="Edit">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z" />
          </svg>
        </button>
        <button className="btn btn-secondary btn-sm btn-delete-row action-icon-btn" onClick={(e) => { e.stopPropagation(); onDelete(); }} aria-label="Delete">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
