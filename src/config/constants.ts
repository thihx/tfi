...
export const STATUS_BADGES: Record<string, StatusBadgeInfo> = {
  ...
  ET: { label: 'ET', class: 'badge-live', title: 'Extra Time' },
  P: { label: 'PEN', class: 'badge-live', title: 'Penalty shootout' },
  BT: { label: 'BT', class: 'badge-live', title: 'Extra-time break' },
  LIVE: { label: '', class: 'badge-live', hidden: true },
  AET: { label: 'AET', class: 'badge-ft', title: 'After Extra Time' },
  PEN: { label: 'PEN', class: 'badge-ft', title: 'After Penalties' },
